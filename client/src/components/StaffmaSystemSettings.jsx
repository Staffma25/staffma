  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>Configure system-wide settings</p>
      </div>
      ...
      <div style={styles.content}>
        {settings.length > 0 ? (
          ...
          <div style={styles.emptyState}>
            ...
            <h3 style={styles.emptyTitle}>No System Settings</h3>
            <p style={styles.emptyText}>
              No system settings are available for configuration.
            </p>
          </div>
        )}
      </div>
