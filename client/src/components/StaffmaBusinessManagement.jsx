  ...
  if (loading) {
    return (
      <div style={styles.container}>
        <div style={styles.loading}>Loading business management...</div>
      </div>
    );
  }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>Manage registered businesses</p>
      </div>
      ...
      <div style={styles.content}>
        {businesses.length > 0 ? (
          ...
          <div style={styles.emptyState}>
            ...
            <h3 style={styles.emptyTitle}>No Businesses to Manage</h3>
