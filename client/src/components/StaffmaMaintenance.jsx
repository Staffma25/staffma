  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>System maintenance and updates</p>
      </div>
        ...
        {maintenance.length > 0 ? (
          <div style={styles.maintenanceList}>
            {maintenance.map((item) => (
              <div key={item.id} style={styles.maintenanceCard}>
                <h3>{item.title}</h3>
          ...
          <div style={styles.emptyState}>
            ...
            <h3 style={styles.emptyTitle}>No Maintenance Required</h3>
